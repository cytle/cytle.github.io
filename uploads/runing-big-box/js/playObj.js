 ...
 */
 function playObj(){
 	...
 	o.injure=function(zd){
 		...
 		if(o.hp<=0){ o.hp="0;" sethp(o.hp);="" game.over(false);="" }="" sethistory();="" console.log("injure");="" o.xspeed+="zd.xspeed*0.9;" o.yspeed+="zd.yspeed*0.9;" };="" o.run="function(){" if(game.isover()){="" o.rect();="" return;="" if(o.hp<100){="" o.hp+="runTime/1000;" }else{="" game.over(true);="" o.movey="0;" o.movex="0;">0?-0.01:0.01);


		//限制最高速度
		if(o.xspeed>=speedMax){
			o.xspeed=speedMax;
		}else if(o.xspeed<=-speedmax){ o.xspeed="-speedMax;" }="" if(o.yspeed="">=speedMax){
			o.yspeed=speedMax;
		}else if(o.yspeed<=-speedmax){ o.yspeed="-speedMax;" }="" 到达顶部="" if(o.y<10){="" o.yspeed*="(-0.3);" o.y="10;" }else="" if(o.y="">game.ch-o.h){
			o.yspeed*=(-0.3);
			o.y=game.ch-o.h;
		}
		o.y+=o.yspeed;
		...
		if(o.x>game.cw-o.w){
			o.xspeed*=(-0.3);
			o.x=game.cw-o.w;
		}else if(o.x<0){ o.xspeed*="(-0.3);" o.x="0;" }="" o.x+="o.xspeed;" o.sixline="getSixLine(o.x,o.y,o.lx,o.ly,o.w,o.h);" o.rect();="" };="" o.init="function(){" clearinterval(o.xspeedup);="" clearinterval(o.yspeedup);="" o.y="(game.ch-o.h)/2;" o.movex="0;" o.movey="0;" o.yspeed="0;" o.xspeed="0;" o.hp="0;" sethp(o.hp);="" function="" sethp(h){="" hp.style.width="h+"%";" sethistory(){="" injure_history.innerhtml="injure_history.innerHTML+"<br">injure:x:"+aPlayerX+" y:"+aPlayerY;
...
function tankObj(){
	...
	o.run=function(){
		//边界检测
		if(o.x<-o.w){ o.xspeed="Math.random()*100*g;" }else="" if(o.x="">game.cw){
			//console.log(o.x)
		...
		if(Math.abs(o.xspeed)<=g 10){="" o.xspeed="(70-Math.random()*140)*g;" }="" o.rect();="" o.fire();="" function="" planeobj(){="" var="" o="this;" o.type="1;" s="Math.ceil(Math.random()*2)-1;" console.log(s);="" enemyobj.call(o,s*game.cw,math.random()*game.ch="" 3+100,30,10,(1-s*2)*400="" rftp);="" 效果类似继承，再调用父类方法="" o.run="function(){" 边界检测="" if(o.x<-o.w||o.x="">game.cw){
			s=1-s;
...
}</=g></-o.w){></-o.w||o.y<-o.h||o.x></0){></=-speedmax){></=-speedmax){></=0){>